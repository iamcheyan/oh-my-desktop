...
Item {
    Component.onCompleted: {
        ...
        ActionManager.register("osd.input-method", "on-screen-display",
            "Show input method OSD", {
            type: "qml",
            call: function(p) {
                GlobalStates.osdInputMethodOpen = true
            }
        }, {description: "Show the input method switch on-screen display"})
    }
}
