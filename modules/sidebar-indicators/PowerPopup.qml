...
// ── Action tile button — icon + label in a clickable cell.
component PanelTile: Item {
    ...
    Rectangle {
        ...
        anchors.fill: parent
        radius: 8
        color: tileMouse.pressed ? TuiStyle.controlHover
            : tile.active ? TuiStyle.accentWash(TuiStyle.accent)
            : tileMouse.containsMouse ? TuiStyle.controlHover
            : "transparent"
...
// ── Section label (small dim caps) — compact sub-heading.
