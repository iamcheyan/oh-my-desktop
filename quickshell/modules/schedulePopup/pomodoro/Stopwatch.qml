        ...
        RowLayout {
            ...
            RippleButton {
                ...
                contentItem: StyledText {
                    ...
                    font.family: Appearance.font.family.monospace
                    color: TimerService.stopwatchRunning ? TuiStyle.fg : TuiStyle.bg
            ...
            RippleButton {
                ...
                colBackground: TimerService.stopwatchRunning ? TuiStyle.panel : TuiStyle.dangerPanel
                colBackgroundHover: TimerService.stopwatchRunning ? TuiStyle.panel : TuiStyle.dangerPanel
                colRipple: TimerService.stopwatchRunning ? TuiStyle.panel : TuiStyle.dangerPanel

                contentItem: StyledText {
                    horizontalAlignment: Text.AlignHCenter
                    font.family: Appearance.font.family.monospace
                    text: TimerService.stopwatchRunning ? Translation.tr("Lap") : Translation.tr("Reset")
                    color: TimerService.stopwatchRunning ? TuiStyle.fg : TuiStyle.red
                }
            }
        }
    }
