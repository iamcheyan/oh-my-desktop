...
Singleton {
    ...
    ColorQuantizer {
        id: wallColorQuant
        property string wallpaperPath: FileUtils.expandHomePath(Config.options.background.wallpaperPath)
        ...
        source: Qt.resolvedUrl(wallpaperIsVideo ? FileUtils.expandHomePath(Config.options.background.thumbnailPath) : wallpaperPath)
        depth: 0 // 2^0 = 1 color
        rescaleSize: 10
    }
    ...
    colors: QtObject {
        ...
        // Misc
        property color colTooltip: "#000000"
        ...
        property color colBarText: m3colors.m3onSurface
    }
    ...
    sizes: QtObject {
        ...
        property real barGap: 4
        property real rightGap: 4
