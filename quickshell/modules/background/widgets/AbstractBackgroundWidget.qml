...
AbstractWidget {
    ...
    property string configuredWallpaperPath: FileUtils.expandHomePath(Config.options.background.wallpaperPath)
    ...
    property string wallpaperPath: wallpaperIsVideo ? FileUtils.expandHomePath(Config.options.background.thumbnailPath) : configuredWallpaperPath
