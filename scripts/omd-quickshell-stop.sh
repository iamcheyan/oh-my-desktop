...
omd_stop_quickshell() {
    ...
    apps="omd-bar omd-desktop omd-overview omd-applauncher omd-clipboard omd-clipboard-store"

    for app in omd-bar omd-desktop omd-overview omd-applauncher omd-clipboard; do
