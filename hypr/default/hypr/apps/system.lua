...
o.window("(io.github.iamcheyan.sumika.bluetui|io.github.iamcheyan.sumika.impala|io.github.iamcheyan.sumika.wiremix|io.github.iamcheyan.sumika.btop|io.github.iamcheyan.sumika.terminal|io.github.iamcheyan.sumika.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|com.gabm.satty|About|TUI.float|imv|mpv)", { tag = "+floating-window" })
...
o.window("io.github.iamcheyan.sumika.screensaver", { fullscreen = true, float = true, animation = "slide" })
