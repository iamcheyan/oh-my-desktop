...
### `docs/` — 文档（90 篇）
- 49 篇活跃文档（`docs/*.md`）
- 41 篇归档文档（`docs/archive/`）

**主要分类**：
- **迁移**：`sumika-shell-migration-*.md`, `personal-settings-migration-*.md`
...
- **架构**：`omd-config-architecture.md`, `module-split-plan.md`, `deployment-portability.md`
